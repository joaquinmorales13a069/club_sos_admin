    ...
    return (
        <section className="space-y-6">
            <div className="flex items-center gap-3">
                ...
                <div>
                    <h2 className="text-lg font-semibold text-[#0066CC]">Gestionar Documentos Médicos</h2>
                    <p className="text-xs text-[#666666]">Sube documentos y asígnalos al miembro correspondiente.</p>
                </div>
            </div>
                            ...
                            <form onSubmit={handleBuscar} className="flex flex-col gap-3">
                                ...
                                <div className="flex gap-2">
                                    <input
                                        ...
                                        placeholder={campo === "nombre" ? "Ej: Juan Pérez" : campo === "cedula" ? "Ej: 001-123456-7890" : "Ej: +505 8888 7777"}
